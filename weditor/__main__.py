...
from .web.handlers.page import (
    ...
    AndroidMockUpdateIndexHandler,AndroidMockAnnotationHandler)
...
def make_app(settings={}):
    application = tornado.web.Application(
        [
            ...
            (r"/quit", QuitHandler),
            (r"/api/AndroidMock/update-index", AndroidMockUpdateIndexHandler),
            (r"/api/AndroidMock/Annotation",AndroidMockAnnotationHandler),
        ],
        **settings)
    return application
